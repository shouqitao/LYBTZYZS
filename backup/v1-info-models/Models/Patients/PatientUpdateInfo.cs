    ...
    public class PatientUpdateInfo
    {
        ...
        public static PatientUpdateInfo FromPatientInfo(PatientInfo patientInfo)
        {
            ...
            return new PatientUpdateInfo
            {
                ...
                // IdCard = null, // 属性不存在：PatientInfo.IdCard
                Address = patientInfo.Address,
                AllergyHistory = patientInfo.AllergyHistory,
                // MedicalHistory = null, // 属性不存在：PatientInfo.MedicalHistory
                // FamilyHistory = null, // 属性不存在：PatientInfo.FamilyHistory
                // Occupation = null, // 属性不存在：PatientInfo.Occupation
                // EmergencyContact = null, // 属性不存在：PatientInfo.EmergencyContact
                // EmergencyPhone = null, // 属性不存在：PatientInfo.EmergencyPhone
                // Remark = null // 属性不存在：PatientInfo.Remark,
        ...
        public bool DetectChanges()
        {
            ...
            HasUnsavedChanges = Name != OriginalData.Name ||
                               ...
                               // MedicalHistory != null || // 属性不存在：PatientInfo.MedicalHistory
                               // FamilyHistory != null || // 属性不存在：PatientInfo.FamilyHistory
                               // Occupation != OriginalData.Occupation || // 属性不存在：PatientInfo.Occupation
                               // EmergencyContact != OriginalData.EmergencyContact || // 属性不存在：PatientInfo.EmergencyContact
                               // EmergencyPhone != OriginalData.EmergencyPhone || // 属性不存在：PatientInfo.EmergencyPhone
                               false; // Remark != OriginalData.Remark; // 属性不存在：PatientInfo.Remark
        ...
        public void Reset()
        {
            if (OriginalData != null)
            {
                ...
                // EmergencyContact = null; // 属性不存在：PatientInfo.EmergencyContact
                // EmergencyPhone = null; // 属性不存在：PatientInfo.EmergencyPhone
                // Remark = OriginalData.Remark; // 属性不存在：PatientInfo.Remark
