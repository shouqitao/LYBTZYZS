...
namespace LYBT.Desktop.Core.Models.MedicalCase
{
    ...
    public class MedicalCaseCreateInfo : BindableBase
    {
        ...
        public void CopyFrom(MedicalCaseInfo existingCase)
        {
            ...
            // PastHistory = existingCase.PastHistory; // 属性不存在：MedicalCaseInfo.PastHistory
            // FamilyHistory = existingCase.FamilyHistory; // 属性不存在：MedicalCaseInfo.FamilyHistory
            // Allergies = existingCase.Allergies; // 属性不存在：MedicalCaseInfo.Allergies
        }
