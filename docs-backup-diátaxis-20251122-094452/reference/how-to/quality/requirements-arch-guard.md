...
2. **强制文档阅读清单**：
   ...
   - [ ] docs/design/medicalcase-consultation-prescription-enhancement-design.md - 三步工作流优化设计
   - [ ] docs/design/medicalcase-consultation-prescription-gap-analysis.md - 现有代码差距分析

   ### Level 3 - 模块文档（根据需求选择）
   - [ ] docs/modules/{module-name}/README.md - 相关模块完整文档
   - [ ] docs/api/{module-name}-api.md - 相关API文档
   - [ ] docs/quick-reference/code-patterns.md - 代码模式参考

   ### Level 4 - 深度参考（可选）
   - [ ] docs/deep/advanced-patterns.md - 7种设计模式实际应用
