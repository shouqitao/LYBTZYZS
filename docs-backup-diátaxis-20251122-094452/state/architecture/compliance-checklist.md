...
- [ ] **文档已阅读**：需求分析前是否已阅读`docs/index.md` + `docs/explanation/business-rules.md` + 相关架构文档？
- [ ] **需求文档创建**：是否在`docs/explanation/requirements/`目录创建了需求文档？
...
- [ ] **设计文档创建**：是否在`docs/explanation/design/`目录创建了设计文档？
...
- **业务规则**: [../business-rules.md](../explanation/business-rules.md) - 14条核心业务规则
