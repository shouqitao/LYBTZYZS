...
class CrossReferenceBuilder:
        ...
        for doc1_path, meta1 in self.documents.items():
            for doc2_path, meta2 in self.documents.items():
                ...
                try:
                    ...
                    print(f"[WARNING] 处理内容提及失败 {doc1_path}: {e}")
    ...
    def generate_cross_reference_data(self) -> Dict:
        ...
        for ref in self.references:
            references_by_source[ref.source_file].append(asdict(ref))
    ...
    def save_results(self, output_path: str) -> None:
        ...
        print(f"[SUCCESS] 交叉引用数据已保存到: {output_file}")
...
"""
        ...
        print(f"[SUCCESS] 交叉引用报告已保存到: {output_path}")

def main():
    """主函数"""
    project_root = Path(__file__).parent.parent.parent

    print("[INFO] 开始构建文档交叉引用系统...")
