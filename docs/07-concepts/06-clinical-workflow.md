...
sources: ["docs/01-product/06-clinical-workflow.md"]
---
...
- [医案模块](modules/medical-case-module.md)：作为核心聚合根，承载了临床工作流的主要数据和状态。
- business-rules：集中定义了REG-BR-001、REG-BR-003、MC-D15等业务规则。(自文档)
