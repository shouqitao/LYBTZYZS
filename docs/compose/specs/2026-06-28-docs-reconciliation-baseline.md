...
- **v1.0 = 136**：AUTH13 + USER12 + PAT13 + HERB13 + FORM13 + MC18 + REG7 + PRINT4 + **Platform43**
...
- 所有声明 128（`02-requirements/README`、`01-vision`、`01-prd`）与 136（根 README、docs/AGENTS）之处，统一为 **136**。
...
6. **数字一致性**：US 总数=136、Platform=43、ADR=12、端口=5300，全仓统一。
...
| B | 范围/计数对齐：US=136、Platform=43、Sync v2.0、SHELL 判定落地、015 并入 013、N1 数据孤立描述 | 高（决策已冻） |
