...
- 差值根因：① `11a-shell.md` 声明"Shell 5 US"，实际定义 SHELL-001/003/004/005/007/**010~019** 共 15 个（010 安装、011 初始化向导、012 自动更新、013 备份恢复、014 审计、015 备份状态、016 配置导入导出、017 生产门控、018 配置中心、019 读卡器诊断）；② `README` 总览(`:195-203`) 只列 5 个 SHELL，漏 10 个。
