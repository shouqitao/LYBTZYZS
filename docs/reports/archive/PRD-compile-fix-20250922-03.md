...
- Users：
  ...
  - `src/Client/Desktop/Modules/Users/Views/UserManagementView.xaml`（如有 DTO 绑定字段）
- Patients：
  - `src/Client/Desktop/Modules/Patients/Services/PatientQueryService.cs:34`（日志输出或逻辑中的 CurrentPage）
- Prescriptions：
