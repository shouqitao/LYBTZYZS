...
| 文档 | 路径 | 行数 | 主要内容 |
|------|------|------|----------|
| 类型清单 | docs/prds-summary/shared-inventory/shared-types.md | 255 | 268+类型完整清单 |
| 依赖关系 | docs/prds-summary/shared-inventory/shared-deps.md | 304 | 3个Mermaid依赖图 |
| 枚举规范 | docs/prds-summary/shared-inventory/shared-enums-spec.md | 518 | i18n、缓存、接口约束 |
| 结构优化 | docs/prds-summary/shared-inventory/shared-structure-proposal.md | 303 | 领域驱动重构方案 |
| 架构门禁 | docs/prds-summary/shared-inventory/shared-arch-gates.md | 409 | 禁止依赖、ArchUnit测试 |
