...
| # | 目录 | 内容 | 文件数 |
|---|------|------|--------|
| 01 | [产品文档](01-product/) | 产品愿景、功能概览、用户角色、业务词汇表、临床工作流 | 7 |
| 02 | [需求文档](02-requirements/) | PRD (15 个模块，138 个 User Stories) + NFR + UI 规范 | 21 |
| 03 | [架构文档](03-architecture/) | 系统架构、数据模型、双模式、ADR (8 条) | 8 |
| 04 | [API 参考](04-api-reference/) | 全部 API 端点文档 | 12 |
| 05 | [开发指南](05-development/) | 快速开始、编码规范、设计模式、测试 | 11 |
| 06 | [运维文档](06-operations/) | 部署、配置、监控、日志 | 6 |
