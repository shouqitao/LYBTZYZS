...
| 02 | [需求文档](02-requirements/) | PRD (14 个模块，131 个功能需求) + NFR + UI 规范 | 17 |
| 03 | [架构文档](03-architecture/) | 系统架构、数据模型、双模式、ADR (6 条) | 13 |
...
4. [系统架构](03-architecture/system-architecture.md) -- 整体架构
