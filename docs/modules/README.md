...
| **药材模块** | 药材字典、库存管理 | 拼音码检索、库存预警、供应商管理 | 中等 | 基础支撑 |
...
### 功能概述
药材模块负责中药材的管理，包括药材字典、库存管理、价格管理、供应商管理等。
...
- `GET /api/herbs/{id}/stock` - 获取药材库存
- `PUT /api/herbs/{id}/stock` - 更新药材库存

### 相关文档
- **[药材模块详细文档](herbs/README.md)**
- **[拼音码检索指南](herbs/pinyin-search.md)**
- **[库存管理指南](herbs/inventory-guide.md)**
...
- **[模块设计指南](../architecture/module-design-guide.md)** - 业务模块化设计标准

### 开发文档
- **[开发指南总览](../development/README.md)** - 开发规范和流程指导
- **[Server端开发指南](../development/server/README.md)** - 后端开发规范和实践
- **[Client端开发指南](../development/client/README.md)** - WPF客户端开发指南
