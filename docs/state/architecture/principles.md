...
- `docs/explanation/business-rules.md` - 业务规则#13
...
- `docs/how-to-guides/shared/quality-standards.md`（计划中）
...
- `docs/how-to-guides/shared/documentation-guidelines.md`
...
**参考资料**：
- `CLAUDE.md` - Section 4.2（代码规范）
- `docs/how-to-guides/shared/dependency-injection-guidelines.md`（计划中）
...
**参考资料**：
- `docs/explanation/architecture/client/README.md` - MVVM架构
...
**参考资料**：
- `CLAUDE.md` - Section 4.2（代码规范）
- `docs/how-to-guides/shared/naming-conventions.md`（计划中）
...
**参考资料**：
- `docs/explanation/business-rules.md` - 业务规则#12（够用即好）
- [ADR-004: Component设计指南](./decisions/ADR-004-component-design-guidelines.md)
...
- `docs/how-to-guides/shared/file-organization-guidelines.md`
...
- **Level 1（核心规则）**：`docs/explanation/business-rules.md`、`docs/reference/quick-reference/`
- **Level 2（架构指南）**：`docs/explanation/architecture/{server|client|shared}/README.md`
- **Level 3（深度参考）**：`docs/reference/modules/`、`docs/deep/`
- **Level 4（设计模式）**：`docs/explanation/architecture/patterns/`
...
- `docs/how-to-guides/mcp-tools-reference.md`
