...
>
> 本文内容**保留作 v2.0 同步模块的设计参考**，不代表 v1.0 可用功能。详见 [17-sync-protocol.md](../03-architecture/17-sync-protocol.md)（v2.0 同步协议规划）与 [05-dual-mode.md](../03-architecture/05-dual-mode.md) N1 决策。
