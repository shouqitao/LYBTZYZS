...
| 10 | sysadmin-home.pen/png | Sysadmin 配置中心 | S | P1 |
...
- **功能**: 数据库管理/远程部署/日志管理/安全审计/数据导入导出
...
| 3 | 安全审计日志 | 🔴 缺失 | 需新建 Sysadmin 审计日志页 |
| 4 | 数据导入导出 | 🔴 缺失 | 需新建 Sysadmin 数据管理页 |
