...
| 文档 | 路径 | 关系 |
|------|------|------|
| 患者管理 PRD | [patients.md](../02-requirements/04-patients.md) | 前台挂号流程 |
| 医案管理 PRD | [medical-cases.md](../02-requirements/07-medical-cases.md) | 诊疗核心流程 |
| 验方管理 PRD | [formulas.md](../02-requirements/06-formulas.md) | 处方导入来源 |
| 药材管理 PRD | [herbs.md](../02-requirements/05-herbs.md) | 药材价格和状态 |
