...
- 路径：src/Server/Modules/LYBT.Module.Patients · 类型：Library · TFM：net8.0
- 职责事实：患者档案管理业务模块，采用UltraThink双层架构，提供完整患者基础信息管理、就诊历史跟踪、联系方式维护、患者状态控制、搜索筛选功能，整合基础患者接待功能，支持小规模诊所患者档案体系
...
- 疑似问题标注：
  ...
  - SuspectRoleMismatch: false（职责完全符合患者管理模块要求：PatientService、PatientQueryService、PatientBusinessService）
