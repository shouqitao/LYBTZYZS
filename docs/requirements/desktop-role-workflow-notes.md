...
- 登录行为：
  ...
  - 其他用户进入诊疗工作台 `ConsultationWorkbenchMainView`。
...
- `ConsultationWorkbenchMainView` 建议后续重命名为“诊疗工作台”，内部再划分子视图：
  1. 患者选择
  2. 四诊录入
  3. 诊断结果
  4. 处方编辑
...
2. 调整命名，将“ConsultationWorkbench”定位为“诊疗工作台”，并确保 `Consultation` 指向诊疗流程本身。
