...
### 前置文档
- **[架构重构方案](../design/medicalcase-consultation-prescription-architecture-refactoring-plan.md)** - 激进版架构重构方案（9个违规修复）
- **[需求讨论文档](../architecture/shared/medicalcase-consultation-prescription-enhancement-discussion.md)** - 业务需求深化讨论（Q1-Q6）
...
### 后续文档
- **[设计文档](../design/medicalcase-consultation-prescription-refactoring-design.md)** - 待生成（需求确认后）⭐
- **[差距分析文档](../design/medicalcase-consultation-prescription-gap-analysis.md)** - 待生成（设计完成后）⭐⭐
