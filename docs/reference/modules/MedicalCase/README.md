...
**完整API文档**: [`docs/reference/api/medicalcase-api.md`](../../api/medicalcase-api.md)
...
5. 更新Service接口和实现
6. 更新Controller端点
7. 更新API文档: `docs/reference/api/medicalcase-api.md`
...
### 核心文档
- **API参考**: [`docs/reference/api/medicalcase-api.md`](../../api/medicalcase-api.md) - 14个API端点完整文档
...
- **API速查**: [`docs/reference/quick-reference/api-reference.md`](../../quick-reference/api-reference.md) - MedicalCase API速查表
