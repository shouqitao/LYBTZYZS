...
详细业务目标见 [vision.md](../01-product/vision.md)。
...
完整端到端流程 (含异常路径、分支流程、并发处理) 见 [clinical-workflow.md](../01-product/clinical-workflow.md)。
...
- [glossary.md](../01-product/glossary.md) -- 中英文术语对照
...
详见 [vision.md](../01-product/vision.md) "版本路线图" 章节。
...
| 文档 | 路径 | 说明 |
|------|------|------|
| 产品愿景 | [vision.md](../01-product/vision.md) | 产品愿景、业务目标、系统边界、版本路线图 |
| 术语表 | [glossary.md](../01-product/glossary.md) | 中英文术语对照 |
| 用户角色 | [user-roles.md](../01-product/user-roles.md) | 角色定义、权限矩阵 |
| 用户画像 | [personas.md](../01-product/personas.md) | Proto-Persona (3 角色日常时间线、痛点、成功标准) |
| JTBD 分析 | [jtbd.md](../01-product/jtbd.md) | Jobs-to-Be-Done (3 角色 10 个 JTBD + 覆盖度审查) |
| 临床工作流 | [clinical-workflow.md](../01-product/clinical-workflow.md) | 端到端流程 (含异常路径) |
| 用户故事地图 | [user-story-map.md](user-story-map.md) | Jeff Patton 故事地图 (4 Narrative + Release Slices) |
| 数据模型 | [data-model.md](../03-architecture/data-model.md) | 实体关系定义 |
| 系统架构 | [system-overview.md](../03-architecture/system-overview.md) | 三层架构、模块结构 |
