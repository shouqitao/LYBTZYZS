...
| 模块 | 错误码范围 | 覆盖场景 |
|------|-----------|---------|
| 用户管理 | 10001-10099 | 用户不存在/密码错误/账号锁定/角色无效等 |
| 患者管理 | 20001-20099 | 患者不存在/身份证重复/引用保护等 |
| 医案管理 | 30001-30099 | 医案不存在/已锁定/并发冲突等 |
| 处方管理 | 40001-40099 | 处方不存在/药材不可用等 |
| 药材管理 | 50001-50099 | 药材不存在/重复/导入错误等 |
| 验方管理 | 60001-60099 | 验方不存在/绑定失败等 |
