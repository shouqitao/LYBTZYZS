...
> 版本: v1.1 | 日期: 2026-08-08 | 状态: ⚠️ 部分完成（US-CARD-001 已实现 / US-CARD-002 待完善）
> Split from 11-platform.md (2026-06-28)
> **状态说明（2026-08-08）**：读卡器整体为「未完成」状态——US-CARD-001 读卡链路已实现可用；**US-CARD-002 患者匹配降级链实现已移除（A-31-C7），待后续完善（用户定：UI 设计时整体考虑）**。
...
**角色**: 前台 / 医生
**优先级**: Should
**状态**: ⚠️ 未完成（实现已移除，待完善——2026-08-08 用户定：UI 设计时整体考虑）
...
| v1.1 | 2026-08-08 | 状态修正：⚠️ 部分完成（US-CARD-001 已实现 / US-CARD-002 待完善） | A-31-C7 移除 MatchPatientAsync 降级链；用户确认读卡器必用、US-CARD-002 后续完善 |
