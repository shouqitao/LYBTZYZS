...
**角色**: sysadmin
**优先级**: Should
**状态**: ⚠️ 部分实现（回滚方案 `docs/06-operations/08-deployment-rollback.md` 已交付；上线检查清单未见。2026-09-24 校准）
...
**角色**: 所有用户
**优先级**: Could
**状态**: ⚠️ 部分实现（培训材料 `training/clinician-training-guide.md` 已交付；FAQ 与支持流程未见。2026-09-24 校准）
