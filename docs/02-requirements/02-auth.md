...
- [业务规则](#业务规则)
- [双模式差异](#双模式差异)
- [本地模式威胁模型（G-02 补写，2026-08-04）](#本地模式威胁模型g-02-补写2026-08-04)
- [用户故事](#用户故事)
- [US-AUTH-000: 首次登录初始化（超管专属）](#us-auth-000-首次登录初始化超管专属)
- [US-AUTH-001: 用户名密码登录](#us-auth-001-用户名密码登录)
- [US-AUTH-002: 登录失败锁定](#us-auth-002-登录失败锁定)
- [US-AUTH-003: 登录限流](#us-auth-003-登录限流)
- [US-AUTH-004: 令牌刷新](#us-auth-004-令牌刷新)
- [US-AUTH-005: 令牌验证](#us-auth-005-令牌验证)
- [US-AUTH-006: 重放攻击检测（令牌族撤销）](#us-auth-006-重放攻击检测令牌族撤销)
- [US-AUTH-007: 安全审计日志](#us-auth-007-安全审计日志)
- [US-AUTH-008: 登出（含过期令牌）](#us-auth-008-登出含过期令牌)
- [US-AUTH-009: 本地自动登录（AutoLoginToken）](#us-auth-009-本地自动登录autologintoken)
- [US-AUTH-010: AutoLoginToken 轮换](#us-auth-010-autologintoken-轮换)
