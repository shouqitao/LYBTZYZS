...
| US-SHELL-003 | Must | ADR-0006/0007 | Flow 4 | ApplicationBootstrapper | ApplicationBootstrapper.cs:35 | — | ✅ 已实现（N5：角色 RequiredModules 含 ClinicalModule——Home 模块对齐；LoginCoordinator 死代码已清——C7 删 HandleLoginSuccessAsync/GetDiagnostics/LoginFlowDiagnostics） | N/A | ✅ |
...
| US-SHELL-021 | Should | — | — | 上线数据迁移（Excel 模板/分批/回滚） | HerbExcelService/FormulaExcelService/ImportBatchRunner/ImportReport + 三导入处理器单事务 | — | ✅ 已实现（2026-09-26，见 11a-shell AC①-⑤） | N/A | ✅ |
| US-SHELL-022 | Should | — | — | 上线检查清单 + 回滚方案 | 13-go-live-checklist.md + 08-deployment-rollback.md | — | ✅ 已实现（2026-09-24 交付 go-live 清单） | N/A | ✅ |
| US-SHELL-023 | Could | — | — | 培训材料 + FAQ + 支持流程 | training/{faq,support-process,quick-start,clinician-training-guide}.md | — | ✅ 已实现（2026-09-24 交付 FAQ+支持流程+三角色快速上手） | N/A | ✅ |
