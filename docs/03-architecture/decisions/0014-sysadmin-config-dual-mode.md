...
- [sysadmin 配置双模式布局](../../02-requirements/11a-shell.md)（US-SHELL-018「双模式面板」段——R10 spec 已归档，sysadmin 配置细节以本 ADR + [11a-shell.md](../../02-requirements/11a-shell.md) US-SHELL-017/018 为准）
