...
**模板文档**：`docs/development/shared/issue-template-v6.md`
...
3. **阅读相关文档**
   - 架构文档：`docs/architecture/{server|client|shared}/`
   - 开发指南：`docs/development/{server|client|shared}/`
...
### 核心文档
- **Issue模板**：`docs/development/shared/issue-template-v6.md`
- **归档清单**：`docs/reports/backlog-archive-2025-10.md`
- **清理指南**：`docs/development/shared/issue-cleanup-guide.md`
