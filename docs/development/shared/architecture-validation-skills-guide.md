...
**参考文档**：
- `docs/design/medicalcase-architecture-correction-plan-v2.md`
- `docs/architecture/server/medicalcase-module.md`
...
**文档路径**：`docs/requirements/medicalcase-consultation-prescription-enhancement-requirements.md`  
...
**文档路径**：`docs/design/medicalcase-consultation-prescription-enhancement-design.md`  
...
### 核心架构文档
- `docs/design/medicalcase-architecture-correction-plan-v2.md` - v2.0三层架构规范
- `docs/architecture/server/medicalcase-module.md` - MedicalCase模块架构
...
### Epic #1589复盘文档
- `docs/requirements/medicalcase-consultation-prescription-enhancement-requirements.md` - 需求文档（违规来源）
- `docs/design/medicalcase-consultation-prescription-enhancement-design.md` - 设计文档（违规来源）
- `docs/design/medicalcase-consultation-prescription-architecture-refactoring-plan.md` - 重构方案
...
- 最新版本始终在 `docs/development/shared/architecture-validation-skills-guide.md`
