...
- ✅ 业务规则必须在`docs/explanation/business-rules.md`中**文档化**
- ✅ 业务规则必须通过**单元测试**验证
...
**文档化要求**（`docs/explanation/business-rules.md`）：
```markdown
### BF-001: 诊断前置规则
...
3. **更新例外清单**：记录到`docs/explanation/architecture/exceptions.md`
4. **团队培训**：确保团队掌握新技术
...
- **架构文档**:
  ...
  - `docs/explanation/architecture/evolution.md` - 架构演进时间线
  - `docs/explanation/architecture/compliance-checklist.md` - 架构合规性检查
...
- [ ] 更新`docs/explanation/architecture/evolution.md`（添加演进触发条件）
- [ ] 更新`docs/explanation/architecture/server/README.md`（引用ADR-005）
