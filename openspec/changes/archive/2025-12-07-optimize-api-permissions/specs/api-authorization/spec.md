...
## Purpose
定义LYBTZYZS项目API端点的授权规范,实现基于角色的细粒度访问控制。
...
- **AUTH-X01:** 不要在Controller中硬编码角色检查,应使用Policy
- **AUTH-X02:** 不要在Service层跳过权限验证直接返回所有数据
- **AUTH-X03:** 不要在Entity中实现权限逻辑,应使用AuthorizationHandler
