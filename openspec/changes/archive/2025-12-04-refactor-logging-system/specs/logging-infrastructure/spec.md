...
定义LYBTZYZS项目的统一日志基础设施规范,包括Server端和Client端的日志配置、CorrelationId追踪、敏感数据脱敏等。
...
| 相关规范 | 关联说明 |
|----------|----------|
| server-layer-architecture | Server层架构,包含异常处理 |
| client-layer-architecture | Client层架构 |
| service-conventions | Service层日志约定 |
| error-handling | 错误处理规范,日志关联 |
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2025-12-04 | 1.0 | 初始版本,定义日志基础设施规范 |
| 2025-12-04 | 1.1 | 新增LOG-007/008/009日志分级存储规范 |
