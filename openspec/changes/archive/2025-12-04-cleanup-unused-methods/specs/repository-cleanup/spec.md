# Spec: repository-cleanup

## Purpose

定义Repository层未被调用方法的清理规范，确保清理工作不影响现有功能。
...
| 相关规范 | 关联说明 |
|----------|----------|
| repository-patterns | Repository层设计模式 |
| data-layer-conventions | 数据层约定 |
...
| 日期 | 版本 | 变更 |
|------|------|------|
| 2025-12-04 | 1.0 | 初始版本，定义未调用方法清理规范 |
