...
2. 查找需求文档 → docs/explanation/consultation-requirements-discussion.md
3. 查找设计文档 → docs/explanation/consultation-design.md
4. 查找相关代码：
...
### 📋 核心文档（优先级：P0）
1. **需求文档**: docs/explanation/consultation-requirements-discussion.md（摘要）
   - 相关需求: REQ-001（查询患者诊疗记录）
2. **设计文档**: docs/explanation/consultation-design.md（完整）
