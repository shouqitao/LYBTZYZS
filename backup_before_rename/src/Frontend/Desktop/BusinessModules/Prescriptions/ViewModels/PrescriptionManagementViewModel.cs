...
namespace LYBT.WPF.Client.BusinessModules.Prescriptions.ViewModels
{
    ...
    /// 处方管理视图模型
    /// </summary>
    public class PrescriptionManagementViewModel : BaseManagementViewModel<PrescriptionDto>
    {
        ...
        private async Task ViewPrescriptionAsync()
        {
            ...
            try
            {
                ...
                _dialogService.ShowDialog("PrescriptionDetailDialog", dialogParameters, null);
            }
            catch (Exception ex)
            {
        ...
        private async Task ShowTemplatesAsync()
        {
            try
            {
                ...
                _dialogService.ShowDialog("PrescriptionTemplatesDialog", dialogParameters, null);
            }
            catch (Exception ex)
            {
        ...
        {
            return SelectedPrescription != null && 
                   SelectedPrescription.Status != PrescriptionStatus.Cancelled;
        }
