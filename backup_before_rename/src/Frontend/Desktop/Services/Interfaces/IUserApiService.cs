...
namespace LYBT.Desktop.Services.Interfaces
{
    ...
    public interface IUserApiService
    {
        ...
        /// </summary>
        [Get("/api/v1/users")]
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<PagedData<UserDto>>>> GetUsersAsync(
            [Query] int page = 1,
        ...
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<object>>> BatchDisableAsync([Body] BatchIdsDto dto);

        /// <summary>
        /// 批量启用用户
        /// </summary>
        [Patch("/api/v1/users/batch-enable")]
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<object>>> BatchEnableAsync([Body] BatchIdsDto dto);

        /// <summary>
        /// 重置用户密码
        /// </summary>
        [Post("/api/v1/users/reset-password/{id}")]
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<object>>> ResetPasswordAsync(Guid id);

        /// <summary>
        /// 修改密码
        /// </summary>
        [Patch("/api/v1/users/password")]
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<object>>> ChangePasswordAsync([Body] ChangePasswordDto dto);

        /// <summary>
        /// 修改个人信息
        /// </summary>
        [Put("/api/v1/users/profile")]
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<object>>> ChangeProfileAsync([Body] ChangeProfileDto dto);

        /// <summary>
        /// 获取所有角色
        /// </summary>
        [Get("/api/v1/users/roles")]
        Task<Refit.ApiResponse<LYBT.Desktop.Core.Models.ApiResponse<IEnumerable<object>>>> GetRolesAsync();
