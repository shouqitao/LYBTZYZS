...
namespace LYBT.Desktop.Shared.ViewModels.Formula
{
    /// <summary>
    /// 验方管理视图模型
    /// </summary>
    public class FormulaManagementViewModel : BaseServiceManagementViewModel<FormulaDto>
    {
        ...
        private async Task ViewFormulaAsync()
        {
            ...
            try
            {
                ...
                _dialogService.ShowDialog("FormulaDetailDialog", dialogParameters, (Action<IDialogResult>)null!);
            }
            catch (Exception ex)
            {
        ...
        private async Task ShowStatisticsAsync()
        {
            ...
            try
            {
                ...
                _dialogService.ShowDialog("FormulaStatisticsDialog", dialogParameters, (Action<IDialogResult>)null!);
            }
            catch (Exception ex)
            {
