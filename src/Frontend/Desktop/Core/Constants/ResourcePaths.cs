namespace LYBT.WPF.Client.Core.Constants
{
    ...
    {
        // Base paths
        private const string AssetsBase = "pack://application:,,,/LYBT.WPF.Client.Shell;component/Assets/";
        private const string ThemesBase = "pack://application:,,,/LYBT.WPF.Client.Shell;component/Themes/";
