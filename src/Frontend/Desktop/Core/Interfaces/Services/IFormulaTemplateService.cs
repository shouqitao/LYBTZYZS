...
namespace LYBT.WPF.Client.Core.Interfaces.Services
{
    ...
    public interface IFormulaTemplateService
    {
        ...
        /// 获取验方模板列表
        /// </summary>
        Task<ServiceResult<List<FormulaTemplateInfo>>> GetListAsync(string? keyword = null, string? category = null);

        /// <summary>
        /// 根据ID获取验方模板详情
        /// </summary>
        Task<ServiceResult<FormulaTemplateDetailDto>> GetByIdAsync(Guid id);

        /// <summary>
        /// 创建验方模板
        /// </summary>
        Task<ServiceResult<FormulaTemplateInfo>> CreateAsync(FormulaTemplateCreateDto createDto);

        /// <summary>
        /// 更新验方模板
        /// </summary>
        Task<ServiceResult<FormulaTemplateInfo>> UpdateAsync(FormulaTemplateUpdateDto updateDto);
        ...
        /// 复制验方模板
        /// </summary>
        Task<ServiceResult<FormulaTemplateInfo>> CopyAsync(Guid id, string newName);
