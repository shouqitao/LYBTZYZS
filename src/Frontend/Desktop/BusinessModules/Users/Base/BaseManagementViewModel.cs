...
{
    /// <summary>
    /// 管理视图模型基类 - 提供标准的CRUD功能和分页支�?    /// </summary>
        ...
        where TService : class
    {
        ...
        /// <summary>状态文�?/summary>
        public virtual string StatusText => $"�?{CurrentPage} 页，�?{TotalPages} 页，总计 {TotalCount} 条记�?;

        /// <summary>是否可以跳转到第一�?/summary>
        public bool CanGoFirstPage => CurrentPage > 1;

        /// <summary>是否可以跳转到上一�?/summary>
        public bool CanGoPreviousPage => CurrentPage > 1;

        /// <summary>是否可以跳转到下一�?/summary>
        public bool CanGoNextPage => CurrentPage < TotalPages;

        /// <summary>是否可以跳转到最后一�?/summary>
        ...
        protected BaseManagementViewModel(TService service)
        {
            ...
            // 初始化命�?            SearchCommand = new DelegateCommand(async () => await LoadDataAsync());
