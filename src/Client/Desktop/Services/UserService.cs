...
namespace LYBT.Desktop.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        /// 搜索用户
        /// </summary>
        public async Task<LYBT.Desktop.Core.Models.Common.PagedResult<UserInfo>> SearchUsersAsync(UserPagedQueryDto request)
        {
            try
            {
                // 使用更新后的RESTful GET接口
                ...
                if (response.IsSuccessStatusCode && response.Content?.Data != null)
                {
                    ...
                    return new LYBT.Desktop.Core.Models.Common.PagedResult<UserInfo>
                    {
                        Items = users,
