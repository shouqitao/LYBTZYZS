    ...
    public class MedicalCaseUpdateInfo : BindableBase
    {
        ...
        public static MedicalCaseUpdateInfo FromMedicalCaseInfo(MedicalCaseInfo medicalCaseInfo)
        {
            return new MedicalCaseUpdateInfo
            {
                ...
                PresentIllness = medicalCaseInfo.PresentIllness,
                PastHistory = medicalCaseInfo.PastHistory,
                FamilyHistory = medicalCaseInfo.FamilyHistory,
                Allergies = medicalCaseInfo.Allergies,
                Diagnosis = medicalCaseInfo.Diagnosis,
                TreatmentPlan = medicalCaseInfo.TreatmentPlan,
                FollowUpPlan = medicalCaseInfo.FollowUpPlan,
                Status = medicalCaseInfo.Status,
                IsUrgent = medicalCaseInfo.IsUrgent,
                AppointmentTime = medicalCaseInfo.AppointmentTime,
                CompleteTime = medicalCaseInfo.CompleteTime,
                Notes = medicalCaseInfo.Notes,
                InternalNotes = medicalCaseInfo.InternalNotes,
                IsModified = false,
                LastModifiedTime = DateTime.Now
            };
        }
        ...
        public bool HasChanges(MedicalCaseInfo original)
        {
            return Id != original.Id ||
                   ...
                   FamilyHistory != original.FamilyHistory ||
                   Allergies != original.Allergies ||
                   Diagnosis != original.Diagnosis ||
                   TreatmentPlan != original.TreatmentPlan ||
                   FollowUpPlan != original.FollowUpPlan ||
