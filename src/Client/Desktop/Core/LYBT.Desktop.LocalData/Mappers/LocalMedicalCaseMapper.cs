...
internal partial class LocalMedicalCaseMapper
{
    ...
    [MapperIgnoreSource(nameof(Prescription.PrintVersion))]
    [MapperIgnoreSource(nameof(Prescription.LastPrintedAt))]
    [MapperIgnoreSource(nameof(Prescription.PrintCount))]
    [MapperIgnoreSource(nameof(Prescription.IsPrinted))]
    [MapperIgnoreSource(nameof(Prescription.PrintLogs))]
