...
LYBT.Desktop.Module.MedicalCase是WPF桌面客户端的医案管理模块，采用MVVM架构和双层服务设计。作为诊疗流程的容器，管理完整的医案信息，包括诊断、处方等。
...
## 🎯 项目概述
- [待补充] 简要描述 MedicalCase 的职责、边界及与其他模块关系。
...
## 🔌 API 接口
- [待补充] 集成的 API/Refit 客户端：例如 IMedicalCaseApi
