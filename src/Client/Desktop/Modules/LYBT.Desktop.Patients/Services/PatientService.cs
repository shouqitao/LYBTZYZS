...
using LYBT.Desktop.Patients.ViewModels.Components; // PatientStateManager
...
namespace LYBT.Desktop.Patients.Services
{
    ...
    public class PatientService
    {
        ...
        private void ExecuteViewMedicalHistory()
        {
            ...
            _navigationCoordinator.NavigateTo(ViewNames.MedicalCaseList, parameters);
        }
        ...
        private void ExecuteBack()
        {
            ...
            _navigationCoordinator.NavigateTo(ViewNames.PatientMasterDetail);
        }
