...
{
    /// <summary>
    /// HerbCardControl - 药材卡片输入控件
    /// Epic #2175 BF-002 Task 3.4 & Task 3.7
    /// 实现药材选择、剂量输入、焦点管理和键盘快捷键
    /// 参考: FormulaModule/HerbCardControl.xaml.cs
    /// </summary>
    public partial class HerbCardControl : UserControl
    {
        ...
        {
            if (DataContext is not PrescriptionItemViewModel viewModel)
                return;
        ...
        {
            // 如果有过滤结果，自动打开建议框
            if (DataContext is PrescriptionItemViewModel viewModel &&
        ...
        /// Epic #2175 BF-002 Task 3.7: 自动添加空行，到达末尾时等待新槽位被添加
        /// </summary>
