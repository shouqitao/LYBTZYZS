...
namespace LYBT.Desktop.MedicalCase
{
    ...
    public class MedicalCaseModule : IModule
    {
        ...
        public void RegisterTypes(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.Register<ViewModels.ConsultationFormViewModel>();      // Epic #1494 - Task #1498: Step 2 诊断表单
            // TODO: 修复编译错误后再启用
            ...
            containerRegistry.RegisterForNavigation<Views.ConsultationFormView>();   // Epic #1494 - Task #1498: Step 2 诊断表单视图
