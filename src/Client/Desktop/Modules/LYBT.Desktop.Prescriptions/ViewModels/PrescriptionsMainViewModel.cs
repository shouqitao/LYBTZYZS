...
namespace LYBT.Desktop.Modules.Prescriptions.ViewModels
{
    ...
    public class PrescriptionsMainViewModel : UnifiedViewModelBase
    {
        ...
        private void CreateNew()
        {
            try
            {
                NavigateTo("PrescriptionContentRegion", "PrescriptionUnifiedView");
                ActiveView = "PrescriptionUnifiedView";
            }
            catch (Exception ex)
            {
        ...
        public void NavigateToEdit(Guid prescriptionId)
        {
            try
            {
                ...
                NavigateTo("PrescriptionContentRegion", "PrescriptionUnifiedView", parameters);
                ActiveView = "PrescriptionUnifiedView";
            }
            catch (Exception ex)
            {
