...
/// </summary>
public class HerbEditContext : ValidatableModelBase
{
    private Guid _id;
    ...
    /// <summary>药材ID (Guid.Empty 表示新建)</summary>
    public Guid Id
    {
        get => _id;
    ...
    [StringLength(ValidationConstants.NameMaxLength, ErrorMessage = "药材名称长度不能超过100个字符")]
    public string Name
    {
        get => _name;
        set
    ...
    /// <summary>功效</summary>
    [StringLength(ValidationConstants.LongRemarkMaxLength, ErrorMessage = "功效描述长度不能超过2000个字符")]
    ...
    [StringLength(ValidationConstants.UsageMaxLength, ErrorMessage = "用法用量长度不能超过200个字符")]
    public string? Usage
    {
        get => _usage;
    ...
    public static HerbEditContext CreateNew()
    {
