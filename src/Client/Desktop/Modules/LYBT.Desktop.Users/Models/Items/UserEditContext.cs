...
namespace LYBT.Desktop.Users.Models.Items
{
    ...
    /// </summary>
    public class UserEditContext : ValidatableModelBase
    {
        private Guid _id;
        ...
        /// <summary>用户名（新建时必填，编辑时不可改）</summary>
        ...
        /// <summary>创建空白实例</summary>
        public static UserEditContext CreateNew()
        {
