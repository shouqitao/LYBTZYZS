...
namespace LYBT.Desktop.Shared.ViewModels.Consultation
{
    /// <summary>
    /// 看诊管理视图模型
    /// </summary>
    public class ConsultationManagementViewModel : BaseServiceManagementViewModel<ConsultationDto>
    {
        ...
        private async Task ViewConsultationAsync()
        {
            ...
            try
            {
                ...
                _dialogService.ShowDialog("ConsultationDialog", dialogParameters, (Action<IDialogResult>)null!);
            }
            catch (Exception ex)
            {
        ...
        private async Task ShowStatisticsAsync()
        {
            try
            {
                ...
                _dialogService.ShowDialog("ConsultationStatisticsDialog", dialogParameters, (Action<IDialogResult>)null!);
            }
            catch (Exception ex)
            {
