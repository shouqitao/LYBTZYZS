...
namespace LYBT.Shared.Interfaces.Services
{
    ...
    public interface IUserService
    {
        ...
        /// <returns>用户操作日志分页列表</returns>
        /// <remarks>
        /// <para>委托: Module → QueryService.GetUserOperationLogsAsync</para>
        /// <para>功能: 查询指定用户的操作审计日志，支持时间范围筛选</para>
        /// <para>权限: 管理员查看所有，普通用户只能查看自己的日志</para>
        /// </remarks>
