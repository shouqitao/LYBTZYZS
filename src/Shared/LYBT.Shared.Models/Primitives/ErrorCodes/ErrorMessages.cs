...
public static class ErrorMessages
{
    private static readonly Dictionary<ErrorCode, (string Zh, string En)> Messages = new()
    {
        ...
        [ErrorCode.UserLocked] = ("账号已被锁定，请稍后重试", "User is locked"),
        ...
        [ErrorCode.AuthTokenRevoked] = ("令牌已被撤销，请重新登录", "Token has been revoked"),
        ...
        // 2xxxx - 患者模块
        [ErrorCode.PatientNotFound] = ("患者不存在", "Patient not found"),
        ...
        [ErrorCode.PatientNotDeleted] = ("该患者未被删除", "Patient is not deleted"),
        ...
        [ErrorCode.McActiveCaseExists] = ("该患者已有进行中的医案，请先完成或重开现有医案", "Active case already exists"),
        [ErrorCode.McSuspendedCaseExists] = ("该患者已有暂存的医案，请先处理现有医案（继续或关闭）", "Suspended case already exists"),
        [ErrorCode.McPatientDisabled] = ("该患者已被禁用，无法创建医案", "Patient is disabled"),
        ...
        [ErrorCode.McPrescriptionFlagRequired] = ("请先标记是否需要开处方", "Prescription flag required"),
        ...
        [ErrorCode.McAlreadyDeleted] = ("医案已被删除", "Case is already deleted"),
        [ErrorCode.McCancelReasonRequired] = ("非当天本人创建的医案取消时必须提供取消原因", "Cancel reason required"),
        [ErrorCode.McPrescriptionItemsRequired] = ("处方必须包含至少一项药材才能完成医案", "Prescription items required"),
        [ErrorCode.McOnlyCompletedCanDelete] = ("仅已完成医案可删除，未完成医案请使用「取消」（物理删除）", "Only completed cases can be deleted"),
        [ErrorCode.MedicalCaseMissingDiagnosis] = ("中医诊断不能为空，请先填写中医诊断", "Missing diagnosis information"),
        ...
        [ErrorCode.HerbNameExists] = ("药材名称已存在", "Herb name already exists"),
        [ErrorCode.HerbValidationFailed] = ("药材验证失败", "Herb validation failed"),
        [ErrorCode.HerbNoPermission] = ("无权限操作此药材", "No permission"),
        [ErrorCode.HerbNotDeleted] = ("药材未被删除，无需恢复", "Herb is not deleted"),
        ...
        [ErrorCode.FormulaNameExists] = ("方剂名称已存在", "Formula name already exists"),
        ...
        [ErrorCode.FormulaNotDeleted] = ("验方未被删除，无需恢复", "Formula is not deleted"),
