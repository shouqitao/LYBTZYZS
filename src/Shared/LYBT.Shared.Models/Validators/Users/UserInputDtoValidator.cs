...
public class UserInputDtoValidator : AbstractValidator<UserInputDto>
{
    public UserInputDtoValidator()
    {
        ...
        RuleFor(x => x.Role).IsInEnum().WithMessage("用户角色值无效").When(x => x.Role.HasValue);
