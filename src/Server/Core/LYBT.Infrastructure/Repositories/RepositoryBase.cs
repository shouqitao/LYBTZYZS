...
namespace LYBT.Infrastructure.Repositories
{
        ...
        where TEntity : class
    {
        ...
        {
            Logger.LogDebug(
                "Getting paged entities of type {EntityType}, Page: {Page}, Size: {Size}",
        ...
        #endregion Query Operations (优化的查询操作)
        ...
        #endregion Command Operations (写操作)
        ...
        #endregion Protected Virtual Methods (子类可重写)
