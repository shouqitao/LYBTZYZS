...
public class LybtOptions
{
    ...
    /// <summary>
    /// 密码策略配置
    /// Issue #1761 Phase 3.1: 从Authentication.PasswordPolicy提升为顶层属性
    /// </summary>
    public PasswordPolicyConfiguration PasswordPolicy { get; set; } = new();

    /// <summary>
    /// 会话配置
    /// Issue #1761 Phase 3.1: 从Authentication.Session提升为顶层属性
    /// </summary>
    public SessionConfiguration Session { get; set; } = new();

    /// <summary>
    /// 默认密码配置
    /// Issue #1761 Phase 3.1: 从Authentication.DefaultPasswords提升为顶层属性
    /// </summary>
    public DefaultPasswordConfiguration DefaultPasswords { get; set; } = new();

    /// <summary>
    /// HTTPS配置
    /// Issue #1761 Phase 3.1: 从Security.Https提升为顶层属性
    /// </summary>
    public HttpsConfiguration Https { get; set; } = new();

    /// <summary>
    /// 安全头配置
    /// Issue #1761 Phase 3.1: 从Security.SecurityHeaders提升为顶层属性
    /// </summary>
    ...
    /// <summary>
    /// 用户管理配置
    /// Issue #1761 Phase 3.1: 从Business.UserManagement提升为顶层属性
    /// </summary>
    public UserManagementConfiguration UserManagement { get; set; } = new();

    /// <summary>
    /// 系统管理员配置
    /// Issue #1761 Phase 3.1: 从Business.SystemAdmin提升为顶层属性
    /// </summary>
    public SystemAdminConfiguration SystemAdmin { get; set; } = new();

    /// <summary>
    /// 诊疗运营配置
    /// Issue #1761 Phase 3.1: 从Business.MedicalOperations提升为顶层属性
    /// </summary>
