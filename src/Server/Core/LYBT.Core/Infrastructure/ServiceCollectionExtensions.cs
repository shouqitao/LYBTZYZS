...
using JwtOptions = LYBT.Core.Infrastructure.Configuration.Options.JwtOptions;

namespace LYBT.Core.Infrastructure
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddInfrastructureDbContext(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<AppDbContext>(options =>
            {
                ...
                {
                    sqlOptions.MigrationsAssembly("LYBT.Core.Infrastructure");
