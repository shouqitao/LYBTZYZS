...
namespace LYBT.Core.Infrastructure.Configuration.Extensions;
...
public static class ConfigurationExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        {
            // TODO: Phase 3 - Map from new LybtOptions structure
            opt.Issuer = lybtOptions.Authentication.Jwt.Issuer;
            opt.Audience = lybtOptions.Authentication.Jwt.Audience;
            // Other properties need to be added to JwtOptions class
        });
        ...
        {
            // TODO: Phase 3 - Map from new LybtOptions structure
            // Properties need to be added to UserOptions class
        });
        ...
        {
            // TODO: Phase 3 - Map from new LybtOptions structure
            // Properties need to be added to DefaultPasswordOptions class
        });

        // 注册传统 RateLimitingOptions
        services.Configure<RateLimitingConfiguration>(opt =>
        {
        ...
        services.Configure<SysAdminOptions>(opt =>
        {
            ...
            // Other properties need to be added to SysAdminOptions class
        });
    }
    ...
    private static void MapToLegacyRateLimitingOptions(RateLimitingConfiguration config, RateLimitingConfiguration legacyOptions)
    {
        // 映射速率限制配置
