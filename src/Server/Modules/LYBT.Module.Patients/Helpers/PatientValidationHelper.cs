    ...
    public class PatientValidationHelper : BaseValidationHelper
    {
        ...
        public async Task<ServiceResult<bool>> ValidateCanDeleteAsync(Guid id)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ServiceResult<bool>.Failure("验证删除权限失败");
            }
        }
        ...
        public async Task<ServiceResult<bool>> ValidateCanUpdateAsync(Guid id)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ServiceResult<bool>.Failure("验证更新权限失败");
            }
        }
        ...
        public ServiceResult<Patient> ProcessIdNumberInfo(Patient model)
        {
            ...
            catch (Exception ex)
            {
                ...
                return ServiceResult<Patient>.Failure("处理身份证信息失败");
            }
        }
        ...
        /// 综合验证患者基本信息
        /// </summary>
        public Task<ServiceResult<bool>> ValidatePatientBasicInfoAsync(PatientCreateDto dto)
        {
            try
            {
                // 验证姓名
                ...
                if (!nameValidation.IsSuccess)
                    return Task.FromResult(nameValidation);
            ...
            catch (Exception ex)
            {
                ...
                return Task.FromResult(ServiceResult<bool>.Failure("验证患者基本信息失败"));
            }
        }
