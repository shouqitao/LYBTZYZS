...
namespace LYBT.Module.Formula.Validators
{
    ...
    /// 验方更新DTO验证器
    /// </summary>
    public class FormulaUpdateDtoValidator : AbstractValidator<FormulaUpdateDto>
    {
        public FormulaUpdateDtoValidator()
        {
            // 验方ID必填
            RuleFor(x => x.Id)
            ...
            // 验证每个药材项
            RuleForEach(x => x.Herbs).SetValidator(new FormulaHerbItemUpdateDtoValidator());
        }
    }
    ...
    /// 验方药材项更新DTO验证器
    /// </summary>
    public class FormulaHerbItemUpdateDtoValidator : AbstractValidator<FormulaHerbItemUpdateDto>
    {
        public FormulaHerbItemUpdateDtoValidator()
        {
            // 药材ID必填
            RuleFor(x => x.HerbId)
