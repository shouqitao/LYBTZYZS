...
namespace LYBT.Module.Formula.Helpers
{
    ...
    public class FormulaCalculationHelper
    {
        ...
        /// 生成验方总结
        /// </summary>
        private async Task<string> GenerateFormulaSummary(LYBT.Entities.Formula.Formula formula, List<Herb> herbs)
        {
        ...
        /// 分析验方功效
        /// </summary>
        private async Task<List<string>> AnalyzeFormulaEffects(List<Herb> herbs)
        {
        ...
        /// 分析禁忌症
        /// </summary>
        private async Task<List<string>> AnalyzeContraindications(List<Herb> herbs)
        {
        ...
        /// 检查药材配伍禁忌
        /// </summary>
        private async Task<List<HerbCompatibilityWarning>> CheckHerbCompatibility(List<Herb> herbs)
        {
        ...
        /// 计算推荐评分
        /// </summary>
        private async Task<List<FormulaRecommendationDto>> CalculateRecommendationScores(
        ...
        /// 综合评分和排序推荐
        /// </summary>
        private async Task<List<FormulaRecommendationDto>> CombineAndScoreRecommendations(
