...
/// <summary>
/// 目录实体状态切换命令验证器（合并 ToggleHerbStatusValidator/ToggleFormulaStatusValidator 孪生）。
...
public class ToggleEntityStatusValidator<TEntity, TDetail> : AbstractValidator<ToggleEntityStatusCommand<TEntity, TDetail>>
    where TEntity : BaseEntity
{
    public ToggleEntityStatusValidator(string entityDisplayName)
    {
        RuleFor(x => x.Id)
