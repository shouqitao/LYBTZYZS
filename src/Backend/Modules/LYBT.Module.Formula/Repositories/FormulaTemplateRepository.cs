...
namespace LYBT.Module.FormulaTemplates.Repositories {
    ...
    public class FormulaTemplateRepository : IFormulaTemplateRepository {
        ...
        /// 获取全部模板列表
        /// </summary>
        public async Task<List<FormulaModel>> GetListAsync() {
        ...
        /// 分页查询验方模板列表
        /// </summary>
        public async Task<(List<FormulaModel> list, int total)> GetPagedAsync(PaginationRequest query, UserRole operatorRole) {
        ...
        public async Task<int> ImportAsync(List<FormulaTemplateImportDto> dtos, Guid operatorId, string operatorName) {
            var models = new List<FormulaModel>();
        ...
        /// 获取所有活动状态的验方模板
        /// </summary>
        public async Task<List<FormulaModel>> GetAllActiveAsync() {
            return await _context.FormulaTemplates
                .Where(f => f.IsActive)
                .OrderBy(f => f.Name)
                .ToListAsync();
        ...
        public async Task<List<FormulaModel>> GetVisibleForDoctorAsync(Guid doctorId) {
            return await _context.FormulaTemplates
