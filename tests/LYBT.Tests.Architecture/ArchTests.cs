...
{
    private static readonly Assembly[] Assemblies = TestAssemblies.Server;

    /// <summary>
    /// 层间依赖测试 - 桌面UI层不得直接依赖Infrastructure层，WebAPI控制器除外
    /// </summary>
    [Fact]
    public void P01_UI_Should_Not_Depend_On_Infrastructure()
    {
    ...
    /// </summary>
    [Fact]
    public void P01c_Desktop_Should_Not_Depend_On_WebAPI()
    {
        var result = Types.InAssemblies(Assemblies)
            .That()
    ...
    /// </summary>
    [Fact]
    public void P02_Controller_Should_Be_In_WebAPI_Project()
    {
    ...
    /// </summary>
    [Fact]
    public void P03_No_Workflow_Framework_References()
    {
    ...
    /// </summary>
    [Fact]
    public void P03b_No_Rules_Engine_References()
    {
    ...
    /// </summary>
    [Fact]
    public void P04_UserName_Convention()
    {
    ...
    /// </summary>
    [Fact]
    public void B01_Cache_Should_Use_ICacheService_Only()
    {
    ...
    /// </summary>
    [Fact]
    public void B01b_Cache_No_Duplicate_Registration()
    {
        // 检查是否存在被删除的重复注册类
    ...
    /// </summary>
    [Fact]
    public void B02_Use_GlobalExceptionHandler_Only()
    {
    ...
    /// </summary>
    [Fact]
    public void B02b_Controllers_Should_Use_BaseApiController()
    {
    ...
    /// </summary>
    [Fact]
    public void B03_Configuration_Use_ConfigurationHelper()
    {
        var webApiAssembly = Assemblies.FirstOrDefault(a => a.GetName().Name == "LYBT.WebAPI");
        if (webApiAssembly == null) return;
    ...
    /// </summary>
    [Fact]
    public void B04_Frontend_Should_Use_Desktop_Namespace()
    {
        // 检查是否还有旧的前端命名空间模式
    ...
    /// </summary>
    [Fact]
    public void B05_No_Reintroduce_Deleted_Components()
    {
    ...
    /// </summary>
    [Fact]
    public void P05_Entities_Should_Not_Depend_On_Shared()
    {
    ...
    /// </summary>
    [Fact]
    public void P05c_SharedUtilities_Should_Not_Depend_On_Swashbuckle()
    {
        var result = Types.InAssemblies(Assemblies)
            .That()
    ...
    /// </summary>
    [Fact]
    public void P05d_Shared_Should_Not_Depend_On_Server_Modules()
    {
        var result = Types.InAssemblies(Assemblies)
            .That()
            .ResideInNamespaceStartingWith("LYBT.Shared")
    ...
    /// </summary>
    [Fact]
    public void P05e_Shared_Should_Not_Depend_On_Desktop()
    {
        var result = Types.InAssemblies(Assemblies)
            .That()
            .ResideInNamespaceStartingWith("LYBT.Shared")
    ...
    /// </summary>
    [Theory]
    [InlineData("LYBT.Entities", new[] { "LYBT.Infrastructure", "LYBT.WebAPI", "LYBT.Module.Identity", "LYBT.Module.Patients", "LYBT.Module.MedicalCases", "LYBT.Module.Catalog" },
        "Entities 层 (最底层) 不得依赖任何上层")]
    [InlineData("LYBT.Infrastructure", new[] { "LYBT.WebAPI", "LYBT.Module.Identity", "LYBT.Module.Patients", "LYBT.Module.MedicalCases", "LYBT.Module.Catalog" },
    ...
    [InlineData("LYBT.Module.Catalog", new[] { "LYBT.WebAPI" }, "Module 层不得依赖 WebAPI 层")]
