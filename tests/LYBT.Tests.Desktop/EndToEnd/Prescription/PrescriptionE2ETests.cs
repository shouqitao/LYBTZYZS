...
namespace LYBT.Tests.Desktop.EndToEnd.Prescription;
...
/// </summary>
public class PrescriptionE2ETests : IClassFixture<DesktopFixture>
{
    private readonly DesktopFixture _fixture;

    public PrescriptionE2ETests(DesktopFixture fixture)
    {
        _fixture = fixture;
    }
