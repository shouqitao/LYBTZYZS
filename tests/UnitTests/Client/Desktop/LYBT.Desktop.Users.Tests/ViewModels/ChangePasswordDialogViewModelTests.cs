...
namespace LYBT.Desktop.Users.Tests.ViewModels
{
    ...
    public class ChangePasswordDialogViewModelTests : IDisposable
    {
        ...
        private readonly Mock<LYBT.Desktop.Users.Interfaces.IUserRepository> _mockUserRepository;
        ...
        public ChangePasswordDialogViewModelTests()
        {
            ...
            _mockUserRepository = new Mock<LYBT.Desktop.Users.Interfaces.IUserRepository>();
        ...
        public void Constructor_ShouldInitializeViewModel()
        {
            ...
            // _viewModel.ConfirmCommand.Should().NotBeNull(); // ConfirmCommand已重命名为ChangePasswordCommand
        ...
        [Fact]
        public void ValidatePasswords_WithEmptyOldPassword_ShouldFail()
        {
            // Arrange
        ...
        {
            // Arrange
            _viewModel.OldPassword = "SamePass123!";
