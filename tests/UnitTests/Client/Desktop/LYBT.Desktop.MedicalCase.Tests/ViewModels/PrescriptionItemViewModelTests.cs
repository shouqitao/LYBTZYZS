...
namespace LYBT.Desktop.MedicalCase.Tests.ViewModels
{
    ...
    public class PrescriptionItemViewModelTests
    {
        ...
        public void FilterHerbs_WhenExactNameMatch_ShouldReturnEmpty()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = "danggui", Price = 15.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "当归尾", PinYinCode = "dangguiwei", Price = 18.0m }
            };
        ...
        public void FilterHerbs_WhenExactPinyinMatch_ShouldScore90Points()
        {
            ...
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = "danggui", Price = 15.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "党参", PinYinCode = "dangshen", Price = 20.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenNamePrefixMatch_ShouldScore80Points()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = "danggui", Price = 15.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "当归尾", PinYinCode = "dangguiwei", Price = 18.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "归脾丸", PinYinCode = "guipiwan", Price = 25.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenPinyinPrefixMatch_ShouldScore70Points()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = "danggui", Price = 15.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "党参", PinYinCode = "dangshen", Price = 20.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "大黄", PinYinCode = "dahuang", Price = 10.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenNameContainsMatchMiddle_ShouldScore50Points()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "生黄芪", PinYinCode = "shenghuangqi", Price = 15.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "黄连", PinYinCode = "huanglian", Price = 20.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenPinyinContainsMatch_ShouldScore40Points()
        {
            ...
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = "danggui", Price = 15.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "黄芪", PinYinCode = "huangqi", Price = 20.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "川芎", PinYinCode = "chuanxiong", Price = 18.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenHerbNameIsNull_ShouldNotThrowException()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                new HerbDto { Id = Guid.NewGuid(), Name = null, PinYinCode = "test", Price = 15.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenPinyinCodeIsNull_ShouldNotThrowException()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = null, Price = 15.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WhenAllHerbsIsEmpty_ShouldReturnEmptyList()
        {
            // Arrange
            var viewModel = CreateViewModel();
            viewModel.AllHerbs = new ObservableCollection<HerbDto>();
        ...
        public void FilterHerbs_WhenMultipleLevelsMatch_ShouldSortCorrectly()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                ...
                new HerbDto { Id = Guid.NewGuid(), Name = "党参", PinYinCode = "dangshen", Price = 20.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "大黄", PinYinCode = "dahuang", Price = 10.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "丹参", PinYinCode = "danshen", Price = 12.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_RealWorldScenario_ShouldWorkCorrectly()
        {
            ...
            var testHerbs = new ObservableCollection<HerbDto>
            {
                ...
                new HerbDto { Id = Guid.NewGuid(), Name = "大黄", PinYinCode = "dahuang", Price = 10.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "丹参", PinYinCode = "danshen", Price = 12.0m },
                new HerbDto { Id = Guid.NewGuid(), Name = "杜仲", PinYinCode = "duzhong", Price = 18.0m }
            };
            viewModel.AllHerbs = testHerbs;
        ...
        public void FilterHerbs_WithLargeDataset_ShouldCompleteQuickly()
        {
            ...
            // 添加目标药材
            testHerbs.Add(new HerbDto { Id = Guid.NewGuid(), Name = "当归", PinYinCode = "danggui", Price = 15.0m });
            viewModel.AllHerbs = testHerbs;
