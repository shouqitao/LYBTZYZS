...
public static class TestDataFactory
{
    ...
    public static Consultation CreateConsultation(Guid? id = null, Guid? medicalCaseId = null, Guid? doctorId = null)
    {
        ...
        return new Consultation
        {
            ...
            Observation = $"望诊：精神可，面色润泽_{Guid.NewGuid():N}",
            Listening = $"闻诊：语声清晰，呼吸平稳_{Guid.NewGuid():N}",
            Inquiry = $"问诊：食欲良好，睡眠正常_{Guid.NewGuid():N}",
            Palpation = $"切诊：腹部柔软，无压痛_{Guid.NewGuid():N}",
