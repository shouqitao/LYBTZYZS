...
namespace LYBT.Infrastructure.Tests.Common.TestBase
{
    /// <summary>
    /// Service层测试基类 - Infrastructure测试版本
    /// 提供统一的配置、Mock、DI设置
    ...
    public abstract class BaseServiceTest<TService> where TService : class
    {
        ...
        protected virtual IConfiguration CreateInMemoryConfiguration()
        {
            ...
            return new LYBT.Infrastructure.Tests.Common.TestConfiguration.InMemoryConfiguration(configData);
        }
