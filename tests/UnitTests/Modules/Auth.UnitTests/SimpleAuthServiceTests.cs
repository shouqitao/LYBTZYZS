...
namespace LYBT.Module.Auth.Tests
{
    ...
    public class SimpleAuthServiceTests
    {
        ...
        {
            // Arrange
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest("testuser", "testpass123");
            var expectedResponse = AuthTestDataGenerator.CreateLoginResponse("test-jwt-token", "testuser", "测试用户");
        ...
        {
            // Arrange
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest("invaliduser", "wrongpass");
        ...
        {
            // Arrange
            var logoutRequest = AuthTestDataGenerator.CreateLogoutRequest("testuser");
        ...
        {
            // Arrange
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest("validuser", "validpass123");
        ...
        {
            // Arrange
            var request = AuthTestDataGenerator.CreateChangePasswordRequest("NewSecurePassword123");
        ...
        {
            // Arrange - 空值测试
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest("", "testpass123");
        ...
        {
            // Arrange - 空值测试
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest("testuser", "");
        ...
        public async Task LoginAsync_With_Long_Username_Should_Handle_Gracefully()
        {
            ...
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest(longUsername, "testpass123");
        ...
        {
            // Arrange - 无效令牌测试
            var loginRequest = AuthTestDataGenerator.CreateLoginRequest("testuser", "invalidpass");
        ...
        {
            // Arrange - 弱密码测试
            var request = AuthTestDataGenerator.CreateChangePasswordRequest("123");
