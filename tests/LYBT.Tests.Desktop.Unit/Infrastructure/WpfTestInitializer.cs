...
public static class WpfTestInitializer
{
        ...
        lock (_lock)
        {
            ...
            if (app != null)
            {
                ...
                app.Resources = new ResourceDictionary
                {
                    ...
                    ["BaseDataGridCell"] = CreateBaseDataGridCellStyle(),
                    ["BaseDataGridRow"] = CreateBaseDataGridRowStyle(),
                    ["BaseDataGridColumnHeader"] = CreateBaseDataGridColumnHeaderStyle(),
    ...
    /// <summary>
    /// 创建用于测试的BaseDataGridCell样式
    /// </summary>
    private static Style CreateBaseDataGridCellStyle()
    {
        var style = new Style(typeof(System.Windows.Controls.DataGridCell));
        style.Setters.Add(new Setter(System.Windows.Controls.DataGridCell.PaddingProperty, new System.Windows.Thickness(4)));
        return style;
    }

    /// <summary>
    /// 创建用于测试的BaseDataGridRow样式
    /// </summary>
    private static Style CreateBaseDataGridRowStyle()
    {
        var style = new Style(typeof(System.Windows.Controls.DataGridRow));
        return style;
    }

    /// <summary>
    /// 创建用于测试的BaseDataGridColumnHeader样式
    /// </summary>
    private static Style CreateBaseDataGridColumnHeaderStyle()
    {
