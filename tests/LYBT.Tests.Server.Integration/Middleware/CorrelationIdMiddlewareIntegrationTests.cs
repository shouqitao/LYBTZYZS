...
namespace LYBT.Tests.Server.Integration.Middleware;
...
public class CorrelationIdMiddlewareIntegrationTests
{
    ...
    public CorrelationIdMiddlewareIntegrationTests(WebApiFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    public async Task MultipleRequests_ShouldGenerateDifferentCorrelationIds()
    {
        ...
        var response1 = await _fixture.AnonymousClient.SendAsync(request1);
        ...
        var response2 = await _fixture.AnonymousClient.SendAsync(request2);
    ...
    public async Task ErrorResponse_ShouldStillIncludeCorrelationIdHeader()
    {
        ...
        // Act
        var response = await _fixture.AdminClient.SendAsync(request);
