...
namespace LYBT.Tests.Server.Patients;
...
/// </summary>
public sealed class PatientIntegrationTests : IntegrationTestBase
{
    ...
    public PatientIntegrationTests(ServerFixture fixture) : base(fixture) { }
    ...
    public async Task Restore_SoftDeletedPatient_ShouldMakeAccessibleAgain()
    {
        ...
        // 软删除
        await admin.DeleteAsync($"/api/v1/patients/{patientId}");
        ...
        // Act - 恢复患者
        var restoreResponse = await admin
    ...
    public async Task AdminUpdate_DoctorCreatedPatient_ShouldSucceed()
    {
        ...
        var createResponse = await doctor
            .PostAsJsonAsync("/api/v1/patients", createRequest);
        createResponse.IsSuccessStatusCode.Should().BeTrue();
