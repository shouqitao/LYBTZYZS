...
namespace LYBT.Tests.Server.Health;
...
public sealed class HealthCheckIntegrationTests : IntegrationTestBase
{
    ...
    public HealthCheckIntegrationTests(ServerFixture fixture, ITestOutputHelper output) : base(fixture)
    {
        _output = output;
    }
    ...
    {
        // Act
        var response = await AnonymousClient.GetAsync($"{BaseUrl}/ping");
    ...
    public async Task Details_WithAuthentication_ShouldReturnDetailedInfo()
    {
        ...
        // Act
        var response = await admin.GetAsync($"{BaseUrl}/details");
    ...
    {
        // Act
        var response = await AnonymousClient.GetAsync($"{BaseUrl}/details");
