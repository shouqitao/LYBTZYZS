...
using LYBT.Tests.Desktop.Integration.LocalMode.Fixtures;
...
namespace LYBT.Tests.Desktop.Integration.EndToEnd.BusinessFlow;
...
/// 数据库: SQLite InMemory (由 LocalModeTestFixture 提供)
/// </summary>
public class BusinessFlowE2ETests : IClassFixture<LocalModeTestFixture>
{
    private readonly LocalModeTestFixture _fixture;

    public BusinessFlowE2ETests(LocalModeTestFixture fixture)
    {
        _fixture = fixture;
    }
