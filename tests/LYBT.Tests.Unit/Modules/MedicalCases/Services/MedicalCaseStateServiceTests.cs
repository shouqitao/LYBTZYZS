...
namespace LYBT.Tests.Unit.Modules.MedicalCases.Services
{
    ...
    public class MedicalCaseStateServiceTests : TestBase
    {
        ...
        [Fact]
        public async Task UpdateStatusAsync_WithCompletedStatus_ShouldThrowBusinessException()
        {
            // Arrange
            var medicalCaseId = Guid.NewGuid();
        ...
        public async Task CompleteAsync_WithAllConditionsMet_ShouldComplete()
        {
            ...
            var medicalCase = new MedicalCaseEntity
            {
                ...
                Prescription = new PrescriptionEntity
                {
                    ...
                    {
                        new() { Id = Guid.NewGuid(), HerbId = Guid.NewGuid(), HerbName = "黄芪", Dosage = 10 }
                    }
                }
            };
        ...
        [Fact]
        public async Task CompleteAsync_WhenPrescriptionNeededButMissing_ShouldThrowBusinessException()
        {
            // Arrange
            var medicalCaseId = Guid.NewGuid();
        ...
        [Fact]
        public async Task CancelAsync_WhenAlreadyCompleted_ShouldThrowBusinessException()
        {
            // Arrange
            var medicalCaseId = Guid.NewGuid();
            var operatorId = Guid.NewGuid();
