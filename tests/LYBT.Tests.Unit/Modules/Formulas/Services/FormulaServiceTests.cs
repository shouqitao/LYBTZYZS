...
namespace LYBT.Tests.Unit.Modules.Formulas.Services
{
    /// <summary>
    /// 方剂服务单元测试
    ...
    public class FormulaServiceTests : TestBase
    {
        ...
        public async Task GetByIdAsync_WithExistingFormula_ShouldReturnFormula()
        {
            ...
            _repositoryMock.GetByIdWithHerbsAsync(formulaId).Returns(formula);
            ...
            await _repositoryMock.Received(1).GetByIdWithHerbsAsync(formulaId);
        }
        ...
        public async Task GetByIdAsync_WithNonExistingFormula_ShouldReturnFailure()
        {
            ...
            _repositoryMock.GetByIdWithHerbsAsync(formulaId).Returns((FormulaEntity?)null);
        ...
        public async Task GetByIdAsync_WhenRepositoryThrowsException_ShouldThrowException()
        {
            ...
            _repositoryMock.GetByIdWithHerbsAsync(formulaId).ThrowsAsync(exception);
        ...
        public async Task GetPagedAsync_WithValidParameters_ShouldReturnPagedResult()
        {
            ...
            _repositoryMock.GetPagedWithDetailsAsync(1, 20, Arg.Any<string?>(), Arg.Any<string?>(), Arg.Any<Guid?>(), Arg.Any<bool>()).Returns(pagedResult);
            ...
            await _repositoryMock.Received(1).GetPagedWithDetailsAsync(1, 20, Arg.Any<string?>(), Arg.Any<string?>(), Arg.Any<Guid?>(), Arg.Any<bool>());
        }
        ...
        public async Task GetPagedAsync_WhenRepositoryThrowsException_ShouldThrowException()
        {
            // Arrange
            var exception = new Exception("数据库错误");
            _repositoryMock.GetPagedWithDetailsAsync(Arg.Any<int>(), Arg.Any<int>(), Arg.Any<string?>(), Arg.Any<string?>(), Arg.Any<Guid?>(), Arg.Any<bool>())
        ...
        public async Task UpdateAsync_WithExistingFormula_ShouldUpdateFormula()
        {
            ...
            _repositoryMock.GetByIdWithHerbsAsync(formulaId).Returns(existingFormula);
        ...
        public async Task SearchAsync_WithMatchingKeyword_ShouldReturnMatchingFormulas()
        {
            ...
            _repositoryMock.GetPagedWithDetailsAsync(1, 100, keyword)
        ...
        public async Task SearchAsync_WhenRepositoryThrowsException_ShouldThrowException()
        {
            ...
            _repositoryMock.GetPagedWithDetailsAsync(Arg.Any<int>(), Arg.Any<int>(), Arg.Any<string?>())
                .ThrowsAsync(exception);
