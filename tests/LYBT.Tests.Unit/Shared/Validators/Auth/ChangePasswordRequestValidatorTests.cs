...
namespace LYBT.Tests.Unit.Shared.Validators.Auth;

/// <summary>
/// ChangePasswordRequestValidator 单元测试
/// 验证规则：OldPassword(必填) + NewPassword(必填,8-50字符,不能与旧密码相同)
/// </summary>
public class ChangePasswordRequestValidatorTests
{
    ...
    [Theory]
    [InlineData("old12345", "new45678")]
    [InlineData("Password1", "Password2")]
    [InlineData("short123", "newPass8!")]
    ...
    public void Validate_WithNewPasswordTooShort_ShouldFail(string newPassword)
    {
        ...
        // Assert
        result.ShouldHaveValidationErrorFor(x => x.NewPassword)
            .WithErrorMessage("新密码长度不能少于8个字符");
    }
    ...
    public void Validate_ShouldReturnCorrectErrorMessages()
    {
        ...
        result.Errors.Should().Contain(e => e.ErrorMessage == "新密码长度不能少于8个字符");
    }
