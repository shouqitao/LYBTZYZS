...
✓ 读取需求文档: docs/requirements/token-security-requirements.md
✓ 读取设计文档: docs/design/token-security-design.md
...
**优先级规则**：
1. Issue描述中明确指定（如 `需求文档: docs/requirements/xxx.md`）
2. 从Epic关联提取（Epic描述中的需求文档链接）
3. 从labels提取（如 `epic:token-security` → 匹配 `docs/requirements/token-security-*.md`）
...
1. Issue描述中明确指定
2. 从Epic关联提取
3. 从Task文档提取（`docs/tasks/xxx-tasks.md` → `docs/design/xxx-design.md`）
4. 文件名匹配
...
**需求文档**: docs/requirements/token-security-requirements.md
**设计文档**: docs/design/token-security-design.md
