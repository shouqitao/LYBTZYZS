...
2. **强制架构文档阅读清单**：
   ...
   ### Level 3 - 设计参考（推荐阅读）
   - [ ] docs/deep/advanced-patterns.md - 7种设计模式
...
### 文档信息
- 设计文档：docs/design/xxx-design.md
...
**Step 1：读取设计文档和架构文档**
- Read设计文档：`docs/design/*.md`
- Read需求文档：`docs/requirements/*.md`
...
文档：docs/design/medicalcase-enhancement-design.md
API端点：5个（全部合规）
架构合规性：0违规
...
**文档**：`docs/design/medicalcase-enhancement-design-v2.md`（假设修复后）
...
docs/design/medicalcase-consultation-prescription-enhancement-design.md
...
```
用户：请验证docs/design/xxx-design.md
