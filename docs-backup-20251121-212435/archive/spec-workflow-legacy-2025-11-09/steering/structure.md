...
├── docs/                         # 项目文档 (三层文档架构)
│   ├── index.md                  # 文档中心索引
│   ├── quick-reference/          # Level 1: 快速参考 (80%日常需求)
│   ├── architecture/             # Level 2: 架构指南 (15%学习需求)
│   ├── development/              # Level 2: 开发指南 (15%学习需求)
│   ├── api/                      # Level 3: API文档 (5%深度需求)
│   └── reports/                  # 分析报告
├── scripts/                      # 构建和部署脚本
├── .spec-workflow/               # Spec工作流文档
│   ├── steering/                 # 指导文档 (product.md, tech.md, structure.md)
│   ├── specs/                    # 需求和设计规格
│   └── approvals/                # 审批流程
├── .github/                      # GitHub配置和工作流
├── .claude/                      # Claude开发环境配置
