...
- 验证文档：`docs/explanation/business-rules.md`（AR-001聚合根规则）
...
- ✅ **API文档更新**：
  - 更新`docs/reference/api/consultation-api.md`（如果删除端点）
  - 更新`docs/reference/api/medicalcase-api.md`（如果新增替代端点）

- ✅ **架构文档更新**：
  - 更新`docs/explanation/architecture/server/README.md`（说明Controller清理）
  - 更新`docs/reference/modules/consultation/README.md`（说明Service简化）

- ✅ **代码模式文档更新**：
  - 更新`docs/reference/quick-reference/code-patterns.md`（Repository可见性规范）
...
2. 删除ConsultationService的2个方法：
   ...
   - `SearchAsync()` → 删除
3. 更新API文档（`docs/reference/api/consultation-api.md`）
4. 编译验证
5. 运行时验证（测试保留的2个端点）
...
5. 更新代码模式文档（`docs/reference/quick-reference/code-patterns.md`）
...
### 架构文档
- `docs/explanation/business-rules.md` - AR-001聚合根规则
- `docs/explanation/architecture/server/README.md` - Server端架构指南

### API文档
- `docs/reference/api/consultation-api.md` - Consultation API端点（需更新）
- `docs/reference/api/medicalcase-api.md` - MedicalCase API端点
