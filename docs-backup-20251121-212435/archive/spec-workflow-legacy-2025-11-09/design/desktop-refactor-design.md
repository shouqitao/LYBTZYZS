...
**需求来源**：[Desktop层架构重构需求文档](../explanation/requirements/desktop-refactor-requirements.md)
...
**文件**：`docs/reference/modules/medicalcase/README.md`
...
**文件**：`docs/reference/modules/prescriptions/README.md`
...
- [ ] 更新`docs/explanation/architecture/client/README.md`（View数量、Services层、技术债统计）
- [ ] 更新`docs/reference/modules/medicalcase/README.md`（删除MedicalCaseQueryService说明）
- [ ] 更新`docs/reference/modules/prescriptions/README.md`（View合并说明）
- [ ] 更新`docs/index.md`（导航链接检查、项目成果）
- [ ] **⭐ 更新`docs/reference/api/medicalcase-api.md`（新增2个端点文档）**
  - 新增端点：`GET /api/v1/medicalcases/patient/{patientId}/unfinished`
  - 新增端点：`PUT /api/v1/medicalcases/{id}/close`
  - 包含请求参数、响应示例、错误码说明
- [ ] **⭐ 更新`docs/reference/quick-reference/api-reference.md`（同步端点列表）**
...
### 需求文档
- **[Desktop层架构重构需求文档](../explanation/requirements/desktop-refactor-requirements.md)** - 5个功能需求、4个非功能需求

### 架构文档
- **[Desktop层架构指南](../explanation/architecture/client/README.md)** - Phase 2四层架构（v5.0）
- **[Server层架构指南](../explanation/architecture/server/README.md)** - 三层架构参考
...
- **[Desktop代码规范](../how-to-guides/client/code-standards.md)** - 代码标准
